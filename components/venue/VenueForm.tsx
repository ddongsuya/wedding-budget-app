...
export const VenueForm: React.FC<VenueFormProps> = ({ initialData, onSubmit, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 pb-20 md:pb-4 bg-black/50 md:bg-stone-900/60 md:backdrop-blur-sm animate-fade-in">
      <div className="bg-white w-full max-h-full md:max-h-[90vh] md:max-w-4xl rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="bg-stone-900 text-white p-4 flex justify-between items-center shrink-0 shadow-lg z-10">
